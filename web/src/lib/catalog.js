...
const PRICE_MODEL = { '침대': [250000, 8], '소파': [180000, 10], '책상': [90000, 6], '의자': [60000, 8], '수납': [80000, 6], '조명': [45000, 15], '러그': [30000, 1.2], '테이블': [50000, 8], 'TV/콘솔': [150000, 7], '냉장고': [350000, 8] };
...
export const CATEGORY_DEFAULTS = [
  ...
  // '냉장고' 안의 '장'이 아래 수납 규칙에 먼저 매치되지 않도록 특수 카테고리를 앞에 둔다.
  { kw: ['TV', '티비', '미디어', '콘솔'], w: 120, d: 40, h: 45, color: '#8f765e', lowBox: true },
  { kw: ['냉장고', '냉장', 'fridge', 'refrigerator'], w: 60, d: 65, h: 170, color: '#e8e8e5', lowBox: false },
...
const CAT_ALIAS = {
  ...
  'TV/콘솔': 'TV/콘솔', TV: 'TV/콘솔', 티비: 'TV/콘솔', 미디어: 'TV/콘솔', 콘솔: 'TV/콘솔',
  냉장고: '냉장고', 냉장: '냉장고', fridge: '냉장고', refrigerator: '냉장고',
};
