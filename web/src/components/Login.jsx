...
export default function Login({ onLogin, onSkip, authError }) {
  const [prov, setProv] = useState(null);   // {kakao,naver,google} | null(조회 중)
  ...
  const demo = prov && !prov.kakao && !prov.naver && !prov.google;
  ...
  return (
    <div className="vscreen login">
      ...
      <div className="actions">
        ...
        <button className="sso naver" onClick={() => go('naver')}>네이버로 계속하기</button>
