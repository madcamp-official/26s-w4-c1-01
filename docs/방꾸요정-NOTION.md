...
> 📱 **https://bangkku-fairy.madcamp-kaist.org** · 안드로이드 APK 제공 · 실측 3D 가구 **201종**
...
#### 🛏️ **실치수 3D 가구 201종**
Amazon Berkeley Objects의 **실측 GLB 184종** + 한국 원룸 표준 규격 17종
...
| **3D 자산** | Amazon Berkeley Objects 실측 GLB **184종** (109MB, CC BY-NC 4.0) |
...
| 지표 | 값 |
| --- | --- |
| 실치수 3D 가구 | **201종** (ABO 실측 GLB 184 + 원룸 표준 규격 17) |
| 3D 자산 용량 | 109MB (GLB 184개 · 텍스처 포함) |
